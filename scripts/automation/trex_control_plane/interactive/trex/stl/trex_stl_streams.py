...
class STLFlowStatsInterface(object):
    def __init__ (self, pg_id, vxlan, gre):
        self.fields = {
            'enabled':      True,
            'stream_id':    pg_id,
            'vxlan':        vxlan,
...
class STLFlowStats(STLFlowStatsInterface):
    ...
    def __init__(self, pg_id, vxlan = False, gre = False):
        super(STLFlowStats, self).__init__(pg_id, vxlan, gre)
...
class STLFlowLatencyStats(STLFlowStatsInterface):
    ...
    def __init__(self, pg_id, vxlan = False, gre = False):
        super(STLFlowLatencyStats, self).__init__(pg_id, vxlan, gre)
