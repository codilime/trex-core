 ...
 * allocator.
 */
static void internalError(void) { EF_Abort("Internal error in allocator."); }
...
extern C_LINKAGE void free(void *address) { ef_free(address); }

extern C_LINKAGE void *realloc(void *oldBuffer, size_t newSize) { return (ef_realloc(oldBuffer, newSize)); }

extern C_LINKAGE void *malloc(size_t size) { return (ef_malloc(size)); }

extern C_LINKAGE void *calloc(size_t nelem, size_t elsize) { return (ef_calloc(nelem, elsize)); }

extern C_LINKAGE int posix_memalign(void **memptr, size_t alignment, size_t size) {
 ...
 * will break some software.
 */
extern C_LINKAGE void *valloc(size_t size) { return (ef_valloc(size)); }
#endif
