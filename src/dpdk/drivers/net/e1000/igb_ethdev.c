...
static int eth_igb_stats_get(struct rte_eth_dev *dev, struct rte_eth_stats *rte_stats);
static int eth_igb_xstats_get(struct rte_eth_dev *dev, struct rte_eth_xstat *xstats, unsigned n);
static int eth_igb_xstats_get_by_id(struct rte_eth_dev *dev, const uint64_t *ids, uint64_t *values, unsigned int n);
static int eth_igb_xstats_get_names(struct rte_eth_dev *dev, struct rte_eth_xstat_name *xstats_names,
                                    unsigned int size);
static int eth_igb_xstats_get_names_by_id(struct rte_eth_dev *dev, struct rte_eth_xstat_name *xstats_names,
                                          const uint64_t *ids, unsigned int limit);
static void eth_igb_stats_reset(struct rte_eth_dev *dev);
static void eth_igb_xstats_reset(struct rte_eth_dev *dev);
static int eth_igb_fw_version_get(struct rte_eth_dev *dev, char *fw_version, size_t fw_size);
static void eth_igb_infos_get(struct rte_eth_dev *dev, struct rte_eth_dev_info *dev_info);
static const uint32_t *eth_igb_supported_ptypes_get(struct rte_eth_dev *dev);
static void eth_igbvf_infos_get(struct rte_eth_dev *dev, struct rte_eth_dev_info *dev_info);
static int eth_igb_flow_ctrl_get(struct rte_eth_dev *dev, struct rte_eth_fc_conf *fc_conf);
static int eth_igb_flow_ctrl_set(struct rte_eth_dev *dev, struct rte_eth_fc_conf *fc_conf);
static int eth_igb_lsc_interrupt_setup(struct rte_eth_dev *dev, uint8_t on);
static int eth_igb_rxq_interrupt_setup(struct rte_eth_dev *dev);
static int eth_igb_interrupt_get_status(struct rte_eth_dev *dev);
static int eth_igb_interrupt_action(struct rte_eth_dev *dev, struct rte_intr_handle *handle);
...
static int eth_igb_vlan_filter_set(struct rte_eth_dev *dev, uint16_t vlan_id, int on);
static int eth_igb_vlan_tpid_set(struct rte_eth_dev *dev, enum rte_vlan_type vlan_type, uint16_t tpid_id);
...
static int eth_igb_rar_set(struct rte_eth_dev *dev, struct ether_addr *mac_addr, uint32_t index, uint32_t pool);
static void eth_igb_rar_clear(struct rte_eth_dev *dev, uint32_t index);
static int eth_igb_default_mac_addr_set(struct rte_eth_dev *dev, struct ether_addr *addr);
...
static int eth_igbvf_stats_get(struct rte_eth_dev *dev, struct rte_eth_stats *rte_stats);
static int eth_igbvf_xstats_get(struct rte_eth_dev *dev, struct rte_eth_xstat *xstats, unsigned n);
static int eth_igbvf_xstats_get_names(struct rte_eth_dev *dev, struct rte_eth_xstat_name *xstats_names, unsigned limit);
static void eth_igbvf_stats_reset(struct rte_eth_dev *dev);
static int igbvf_vlan_filter_set(struct rte_eth_dev *dev, uint16_t vlan_id, int on);
static int igbvf_set_vfta(struct e1000_hw *hw, uint16_t vid, bool on);
static void igbvf_set_vfta_all(struct rte_eth_dev *dev, bool on);
static int igbvf_default_mac_addr_set(struct rte_eth_dev *dev, struct ether_addr *addr);
static int igbvf_get_reg_length(struct rte_eth_dev *dev);
static int igbvf_get_regs(struct rte_eth_dev *dev, struct rte_dev_reg_info *regs);

static int eth_igb_rss_reta_update(struct rte_eth_dev *dev, struct rte_eth_rss_reta_entry64 *reta_conf,
                                   uint16_t reta_size);
static int eth_igb_rss_reta_query(struct rte_eth_dev *dev, struct rte_eth_rss_reta_entry64 *reta_conf,
                                  uint16_t reta_size);

static int eth_igb_syn_filter_get(struct rte_eth_dev *dev, struct rte_eth_syn_filter *filter);
static int eth_igb_syn_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg);
static int igb_add_2tuple_filter(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter);
static int igb_remove_2tuple_filter(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter);
static int eth_igb_get_flex_filter(struct rte_eth_dev *dev, struct rte_eth_flex_filter *filter);
static int eth_igb_flex_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg);
static int igb_add_5tuple_filter_82576(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter);
static int igb_remove_5tuple_filter_82576(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter);
static int igb_get_ntuple_filter(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *filter);
static int igb_ntuple_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg);
static int igb_ethertype_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg);
static int igb_get_ethertype_filter(struct rte_eth_dev *dev, struct rte_eth_ethertype_filter *filter);
static int eth_igb_filter_ctrl(struct rte_eth_dev *dev, enum rte_filter_type filter_type, enum rte_filter_op filter_op,
                               void *arg);
static int eth_igb_get_reg_length(struct rte_eth_dev *dev);
static int eth_igb_get_regs(struct rte_eth_dev *dev, struct rte_dev_reg_info *regs);
static int eth_igb_get_eeprom_length(struct rte_eth_dev *dev);
static int eth_igb_get_eeprom(struct rte_eth_dev *dev, struct rte_dev_eeprom_info *eeprom);
static int eth_igb_set_eeprom(struct rte_eth_dev *dev, struct rte_dev_eeprom_info *eeprom);
static int eth_igb_get_module_info(struct rte_eth_dev *dev, struct rte_eth_dev_module_info *modinfo);
static int eth_igb_get_module_eeprom(struct rte_eth_dev *dev, struct rte_dev_eeprom_info *info);
static int eth_igb_set_mc_addr_list(struct rte_eth_dev *dev, struct ether_addr *mc_addr_set, uint32_t nb_mc_addr);
static int igb_timesync_enable(struct rte_eth_dev *dev);
static int igb_timesync_disable(struct rte_eth_dev *dev);
static int igb_timesync_read_rx_timestamp(struct rte_eth_dev *dev, struct timespec *timestamp, uint32_t flags);
static int igb_timesync_read_tx_timestamp(struct rte_eth_dev *dev, struct timespec *timestamp);
static int igb_timesync_adjust_time(struct rte_eth_dev *dev, int64_t delta);
static int igb_timesync_read_time(struct rte_eth_dev *dev, struct timespec *timestamp);
static int igb_timesync_write_time(struct rte_eth_dev *dev, const struct timespec *timestamp);
...
static void eth_igb_assign_msix_vector(struct e1000_hw *hw, int8_t direction, uint8_t queue, uint8_t msix_vector);
static void eth_igb_write_ivar(struct e1000_hw *hw, uint8_t msix_vector, uint8_t index, uint8_t offset);
...
static const struct rte_igb_xstats_name_off rte_igb_stats_strings[] = {
    ...
    {"rx_flow_control_unsupported_packets", offsetof(struct e1000_hw_stats, fcruc)},
...
#define IGB_NB_XSTATS (sizeof(rte_igb_stats_strings) / sizeof(rte_igb_stats_strings[0]))
...
#define IGBVF_NB_XSTATS (sizeof(rte_igbvf_stats_strings) / sizeof(rte_igbvf_stats_strings[0]))
...
static inline void igb_intr_enable(struct rte_eth_dev *dev) {
    ...
    if (rte_intr_allow_others(intr_handle) && dev->data->dev_conf.intr_conf.lsc != 0) {
...
static void igb_identify_hardware(struct rte_eth_dev *dev, struct rte_pci_device *pci_dev) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int eth_igb_dev_init(struct rte_eth_dev *eth_dev) {
    ...
    struct e1000_vfta *shadow_vfta = E1000_DEV_PRIVATE_TO_VFTA(eth_dev->data->dev_private);
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(eth_dev->data->dev_private);
    ...
    PMD_INIT_LOG(DEBUG, "port_id %d vendorID=0x%x deviceID=0x%x", eth_dev->data->port_id, pci_dev->id.vendor_id,
...
static int eth_igb_dev_uninit(struct rte_eth_dev *eth_dev) {
    ...
    rte_intr_callback_unregister(intr_handle, eth_igb_interrupt_handler, eth_dev);
    ...
    memset(filter_info->ethertype_filters, 0, E1000_MAX_ETQF_FILTERS * sizeof(struct igb_ethertype_filter));
...
static int eth_igbvf_dev_init(struct rte_eth_dev *eth_dev) {
    ...
    /* Allocate memory for storing MAC addresses */
    eth_dev->data->mac_addrs = rte_zmalloc("igbvf", ETHER_ADDR_LEN * hw->mac.rar_entry_count, 0);
    if (eth_dev->data->mac_addrs == NULL) {
        PMD_INIT_LOG(ERR,
    ...
    PMD_INIT_LOG(DEBUG,
                 ...
                 "mac.type=%s",
                 eth_dev->data->port_id, pci_dev->id.vendor_id, pci_dev->id.device_id, "igb_mac_82576_vf");
...
static int eth_igbvf_dev_uninit(struct rte_eth_dev *eth_dev) {
    ...
    rte_intr_callback_unregister(&pci_dev->intr_handle, eth_igbvf_interrupt_handler, (void *)eth_dev);

    return 0;
}

static int eth_igb_pci_probe(struct rte_pci_driver *pci_drv __rte_unused, struct rte_pci_device *pci_dev) {
    return rte_eth_dev_pci_generic_probe(pci_dev, sizeof(struct e1000_adapter), eth_igb_dev_init);
}
...
static int eth_igbvf_pci_probe(struct rte_pci_driver *pci_drv __rte_unused, struct rte_pci_device *pci_dev) {
    return rte_eth_dev_pci_generic_probe(pci_dev, sizeof(struct e1000_adapter), eth_igbvf_dev_init);
}
...
static int igb_check_mq_mode(struct rte_eth_dev *dev) {
    ...
    if ((rx_mq_mode & ETH_MQ_RX_DCB_FLAG) || tx_mq_mode == ETH_MQ_TX_DCB || tx_mq_mode == ETH_MQ_TX_VMDQ_DCB) {
    ...
    if (RTE_ETH_DEV_SRIOV(dev).active != 0) {
        ...
        if (rx_mq_mode == ETH_MQ_RX_NONE || rx_mq_mode == ETH_MQ_RX_VMDQ_ONLY) {
         ...
         */
        if (rx_mq_mode != ETH_MQ_RX_NONE && rx_mq_mode != ETH_MQ_RX_VMDQ_ONLY && rx_mq_mode != ETH_MQ_RX_RSS) {
...
static int eth_igb_start(struct rte_eth_dev *dev) {
    ...
    if ((hw->mac.type == e1000_82576) || (hw->mac.type == e1000_82580) || (hw->mac.type == e1000_i350) ||
    ...
    if (*speeds == ETH_LINK_SPEED_AUTONEG) {
        ...
        if (*speeds & ~(ETH_LINK_SPEED_10M_HD | ETH_LINK_SPEED_10M | ETH_LINK_SPEED_100M_HD | ETH_LINK_SPEED_100M |
    ...
    if (rte_intr_allow_others(intr_handle)) {
        ...
        rte_intr_callback_unregister(intr_handle, eth_igb_interrupt_handler, (void *)dev);
        if (dev->data->dev_conf.intr_conf.lsc != 0)
...
error_invalid_config:
    PMD_INIT_LOG(ERR, "Invalid advertised speeds (%u) for port %u", dev->data->dev_conf.link_speeds,
                 dev->data->port_id);
    igb_dev_clear_queues(dev);
    return -EINVAL;
}
...
static void eth_igb_stop(struct rte_eth_dev *dev) {
    ...
    if (!rte_intr_allow_others(intr_handle))
        ...
        rte_intr_callback_register(intr_handle, eth_igb_interrupt_handler, (void *)dev);
...
static void igb_read_stats_registers(struct e1000_hw *hw, struct e1000_hw_stats *stats) {
    int pause_frames;
    ...
    if (hw->phy.media_type == e1000_media_type_copper || (E1000_READ_REG(hw, E1000_STATUS) & E1000_STATUS_LU)) {
...
static int eth_igb_stats_get(struct rte_eth_dev *dev, struct rte_eth_stats *rte_stats) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_hw_stats *stats = E1000_DEV_PRIVATE_TO_STATS(dev->data->dev_private);
    ...
    rte_stats->ierrors =
        stats->crcerrs + stats->rlec + stats->ruc + stats->roc + stats->rxerrc + stats->algnerrc + stats->cexterr;
...
static void eth_igb_stats_reset(struct rte_eth_dev *dev) {
    struct e1000_hw_stats *hw_stats = E1000_DEV_PRIVATE_TO_STATS(dev->data->dev_private);
...
static int eth_igb_xstats_get_names(__rte_unused struct rte_eth_dev *dev, struct rte_eth_xstat_name *xstats_names,
    ...
    for (i = 0; i < IGB_NB_XSTATS; i++) {
        strlcpy(xstats_names[i].name, rte_igb_stats_strings[i].name, sizeof(xstats_names[i].name));
    }
...
static int eth_igb_xstats_get_names_by_id(struct rte_eth_dev *dev, struct rte_eth_xstat_name *xstats_names,
    ...
    if (!ids) {
        ...
        eth_igb_xstats_get_names_by_id(dev, xstats_names_copy, NULL, IGB_NB_XSTATS);
...
static int eth_igb_xstats_get(struct rte_eth_dev *dev, struct rte_eth_xstat *xstats, unsigned n) {
    ...
    for (i = 0; i < IGB_NB_XSTATS; i++) {
        xstats[i].id = i;
        xstats[i].value = *(uint64_t *)(((char *)hw_stats) + rte_igb_stats_strings[i].offset);
    }
...
static int eth_igb_xstats_get_by_id(struct rte_eth_dev *dev, const uint64_t *ids, uint64_t *values, unsigned int n) {
    ...
    if (!ids) {
        ...
        /* Extended stats */
        for (i = 0; i < IGB_NB_XSTATS; i++)
            values[i] = *(uint64_t *)(((char *)hw_stats) + rte_igb_stats_strings[i].offset);
...
static void igbvf_read_stats_registers(struct e1000_hw *hw, struct e1000_vf_stats *hw_stats) {
...
static int eth_igbvf_xstats_get_names(__rte_unused struct rte_eth_dev *dev, struct rte_eth_xstat_name *xstats_names,
                                      __rte_unused unsigned limit) {
    unsigned i;

    if (xstats_names != NULL)
        for (i = 0; i < IGBVF_NB_XSTATS; i++) {
            strlcpy(xstats_names[i].name, rte_igbvf_stats_strings[i].name, sizeof(xstats_names[i].name));
        }
...
static int eth_igbvf_xstats_get(struct rte_eth_dev *dev, struct rte_eth_xstat *xstats, unsigned n) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_vf_stats *hw_stats = (struct e1000_vf_stats *)E1000_DEV_PRIVATE_TO_STATS(dev->data->dev_private);
    unsigned i;
    ...
    for (i = 0; i < IGBVF_NB_XSTATS; i++) {
        xstats[i].id = i;
        xstats[i].value = *(uint64_t *)(((char *)hw_stats) + rte_igbvf_stats_strings[i].offset);
    }
...
static void eth_igbvf_stats_reset(struct rte_eth_dev *dev) {
    ...
    memset(&hw_stats->gprc, 0, sizeof(*hw_stats) - offsetof(struct e1000_vf_stats, gprc));
}
...
static int eth_igb_fw_version_get(struct rte_eth_dev *dev, char *fw_version, size_t fw_size) {
    ...
    case e1000_i211:
        if (!(e1000_get_flash_presence_i210(hw))) {
            ret = snprintf(fw_version, fw_size, "%2d.%2d-%d", fw.invm_major, fw.invm_minor, fw.invm_img_type);
            break;
        }
        /* fall through */
    default:
        ...
        if (fw.or_valid) {
            ret = snprintf(fw_version, fw_size, "%d.%d, 0x%08x, %d.%d.%d", fw.eep_major, fw.eep_minor, fw.etrack_id,
                           fw.or_major, fw.or_build, fw.or_patch);
            /* no option rom */
        } else {
            if (fw.etrack_id != 0X0000) {
                ret = snprintf(fw_version, fw_size, "%d.%d, 0x%08x", fw.eep_major, fw.eep_minor, fw.etrack_id);
            } else {
                ret = snprintf(fw_version, fw_size, "%d.%d.%d", fw.eep_major, fw.eep_minor, fw.eep_build);
            }
        }
        break;
    }
...
static void eth_igb_infos_get(struct rte_eth_dev *dev, struct rte_eth_dev_info *dev_info) {
    ...
    dev_info->rx_offload_capa = igb_get_rx_port_offloads_capa(dev) | dev_info->rx_queue_offload_capa;
    dev_info->tx_queue_offload_capa = igb_get_tx_queue_offloads_capa(dev);
    dev_info->tx_offload_capa = igb_get_tx_port_offloads_capa(dev) | dev_info->tx_queue_offload_capa;
    ...
    dev_info->speed_capa =
        ETH_LINK_SPEED_10M_HD | ETH_LINK_SPEED_10M | ETH_LINK_SPEED_100M_HD | ETH_LINK_SPEED_100M | ETH_LINK_SPEED_1G;
...
static const uint32_t *eth_igb_supported_ptypes_get(struct rte_eth_dev *dev) {
    static const uint32_t ptypes[] = {/* refers to igb_rxd_pkt_info_to_pkt_type() */
                                      RTE_PTYPE_L2_ETHER,
                                      RTE_PTYPE_L3_IPV4,
    ...
    if (dev->rx_pkt_burst == eth_igb_recv_pkts || dev->rx_pkt_burst == eth_igb_recv_scattered_pkts)
        return ptypes;
    return NULL;
}
...
static void eth_igbvf_infos_get(struct rte_eth_dev *dev, struct rte_eth_dev_info *dev_info) {
    ...
    dev_info->max_rx_pktlen = 0x3FFF; /* See RLPML register. */
    dev_info->max_mac_addrs = hw->mac.rar_entry_count;
    dev_info->tx_offload_capa = DEV_TX_OFFLOAD_VLAN_INSERT | DEV_TX_OFFLOAD_IPV4_CKSUM | DEV_TX_OFFLOAD_UDP_CKSUM |
...
static int eth_igb_link_update(struct rte_eth_dev *dev, int wait_to_complete) {
    ...
    if (link_check) {
        ...
        link.link_duplex = (duplex == FULL_DUPLEX) ? ETH_LINK_FULL_DUPLEX : ETH_LINK_HALF_DUPLEX;
...
static int eth_igb_vlan_filter_set(struct rte_eth_dev *dev, uint16_t vlan_id, int on) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_vfta *shadow_vfta = E1000_DEV_PRIVATE_TO_VFTA(dev->data->dev_private);
    uint32_t vfta;
    uint32_t vid_idx;
    uint32_t vid_bit;

    vid_idx = (uint32_t)((vlan_id >> E1000_VFTA_ENTRY_SHIFT) & E1000_VFTA_ENTRY_MASK);
...
static int eth_igb_vlan_tpid_set(struct rte_eth_dev *dev, enum rte_vlan_type vlan_type, uint16_t tpid) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    uint32_t reg, qinq;
    ...
    if (qinq && vlan_type == ETH_VLAN_TYPE_OUTER) {
        ...
        reg = (reg & (~E1000_VET_VET_EXT)) | ((uint32_t)tpid << E1000_VET_VET_EXT_SHIFT);
...
static void igb_vlan_hw_extend_disable(struct rte_eth_dev *dev) {
    ...
    if (dev->data->dev_conf.rxmode.offloads & DEV_RX_OFFLOAD_JUMBO_FRAME)
        E1000_WRITE_REG(hw, E1000_RLPML, dev->data->dev_conf.rxmode.max_rx_pkt_len + VLAN_TAG_SIZE);
}
...
static void igb_vlan_hw_extend_enable(struct rte_eth_dev *dev) {
    ...
    /* Update maximum packet length */
    if (dev->data->dev_conf.rxmode.offloads & DEV_RX_OFFLOAD_JUMBO_FRAME)
        E1000_WRITE_REG(hw, E1000_RLPML, dev->data->dev_conf.rxmode.max_rx_pkt_len + 2 * VLAN_TAG_SIZE);
}
 ...
 *  - On failure, a negative value.
 */
static int eth_igb_interrupt_action(struct rte_eth_dev *dev, struct rte_intr_handle *intr_handle) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_interrupt *intr = E1000_DEV_PRIVATE_TO_INTR(dev->data->dev_private);
    struct rte_pci_device *pci_dev = RTE_ETH_DEV_TO_PCI(dev);
    struct rte_eth_link link;
    ...
    if (intr->flags & E1000_FLAG_NEED_LINK_UPDATE) {
        ...
        if (link.link_status) {
            PMD_INIT_LOG(INFO, " Port %d: Link Up - speed %u Mbps - %s", dev->data->port_id, (unsigned)link.link_speed,
                         link.link_duplex == ETH_LINK_FULL_DUPLEX ? "full-duplex" : "half-duplex");
        } else {
            PMD_INIT_LOG(INFO, " Port %d: Link Down", dev->data->port_id);
        }

        PMD_INIT_LOG(DEBUG, "PCI Address: %04d:%02d:%02d:%d", pci_dev->addr.domain, pci_dev->addr.bus,
...
static int eth_igbvf_interrupt_action(struct rte_eth_dev *dev, struct rte_intr_handle *intr_handle) {
    struct e1000_interrupt *intr = E1000_DEV_PRIVATE_TO_INTR(dev->data->dev_private);
...
static int eth_igb_flow_ctrl_set(struct rte_eth_dev *dev, struct rte_eth_fc_conf *fc_conf) {
    struct e1000_hw *hw;
    int err;
    enum e1000_fc_mode rte_fcmode_2_e1000_fcmode[] = {e1000_fc_none, e1000_fc_rx_pause, e1000_fc_tx_pause,
                                                      e1000_fc_full};
    uint32_t rx_buf_size;
...
static int eth_igb_rss_reta_query(struct rte_eth_dev *dev, struct rte_eth_rss_reta_entry64 *reta_conf,
    ...
    for (i = 0; i < reta_size; i += IGB_4_BIT_WIDTH) {
        ...
        for (j = 0; j < IGB_4_BIT_WIDTH; j++) {
            if (mask & (0x1 << j))
                reta_conf[idx].reta[shift + j] = ((reta >> (CHAR_BIT * j)) & IGB_8_BIT_MASK);
        }
    }
...
int eth_igb_syn_filter_set(struct rte_eth_dev *dev, struct rte_eth_syn_filter *filter, bool add) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
    ...
    if (add) {
        ...
        synqf = (uint32_t)(((filter->queue << E1000_SYN_FILTER_QUEUE_SHIFT) & E1000_SYN_FILTER_QUEUE) |
...
static int eth_igb_syn_filter_get(struct rte_eth_dev *dev, struct rte_eth_syn_filter *filter) {
    ...
    if (synqf & E1000_SYN_FILTER_ENABLE) {
        ...
        filter->queue = (uint8_t)((synqf & E1000_SYN_FILTER_QUEUE) >> E1000_SYN_FILTER_QUEUE_SHIFT);
        return 0;
    }
...
static int eth_igb_syn_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg) {
    ...
    case RTE_ETH_FILTER_ADD:
        ret = eth_igb_syn_filter_set(dev, (struct rte_eth_syn_filter *)arg, TRUE);
        break;
    case RTE_ETH_FILTER_DELETE:
        ret = eth_igb_syn_filter_set(dev, (struct rte_eth_syn_filter *)arg, FALSE);
        break;
    case RTE_ETH_FILTER_GET:
        ret = eth_igb_syn_filter_get(dev, (struct rte_eth_syn_filter *)arg);
        break;
    default:
...
static inline int ntuple_filter_to_2tuple(struct rte_eth_ntuple_filter *filter,
...
static inline struct e1000_2tuple_filter *igb_2tuple_filter_lookup(struct e1000_2tuple_filter_list *filter_list,
                                                                   struct e1000_2tuple_filter_info *key) {
    struct e1000_2tuple_filter *it;

    TAILQ_FOREACH(it, filter_list, entries) {
        if (memcmp(key, &it->filter_info, sizeof(struct e1000_2tuple_filter_info)) == 0) {
            return it;
        }
    }
    return NULL;
...
static inline void igb_inject_2uple_filter(struct rte_eth_dev *dev, struct e1000_2tuple_filter *filter) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int igb_add_2tuple_filter(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter) {
    ...
    filter = rte_zmalloc("e1000_2tuple_filter", sizeof(struct e1000_2tuple_filter), 0);
    if (filter == NULL)
        return -ENOMEM;
    ...
    if (igb_2tuple_filter_lookup(&filter_info->twotuple_list, &filter->filter_info) != NULL) {
...
int igb_delete_2tuple_filter(struct rte_eth_dev *dev, struct e1000_2tuple_filter *filter) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
...
static int igb_remove_2tuple_filter(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter) {
    ...
    filter = igb_2tuple_filter_lookup(&filter_info->twotuple_list, &filter_2tuple);
    if (filter == NULL) {
...
static inline void igb_inject_flex_filter(struct rte_eth_dev *dev, struct e1000_flex_filter *filter) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    ...
    E1000_WRITE_REG(hw, E1000_WUFC, wufc | E1000_WUFC_FLEX_HQ | (E1000_WUFC_FLX0 << filter->index));
    queueing = filter->filter_info.len | (filter->queue << E1000_FHFT_QUEUEING_QUEUE_SHIFT) |
...
static inline struct e1000_flex_filter *eth_igb_flex_filter_lookup(struct e1000_flex_filter_list *filter_list,
                                                                   struct e1000_flex_filter_info *key) {
    struct e1000_flex_filter *it;

    TAILQ_FOREACH(it, filter_list, entries) {
        if (memcmp(key, &it->filter_info, sizeof(struct e1000_flex_filter_info)) == 0)
            return it;
    }
 ...
 */
void igb_remove_flex_filter(struct rte_eth_dev *dev, struct e1000_flex_filter *filter) {
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    uint32_t wufc, i;
    uint32_t reg_off;
...
int eth_igb_add_del_flex_filter(struct rte_eth_dev *dev, struct rte_eth_flex_filter *filter, bool add) {
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
    struct e1000_flex_filter *flex_filter, *it;
    uint32_t mask;
    uint8_t shift, i;

    flex_filter = rte_zmalloc("e1000_flex_filter", sizeof(struct e1000_flex_filter), 0);
    if (flex_filter == NULL)
        return -ENOMEM;
    ...
    it = eth_igb_flex_filter_lookup(&filter_info->flex_list, &flex_filter->filter_info);
    if (it == NULL && !add) {
        PMD_DRV_LOG(ERR, "filter doesn't exist.");
...
static int eth_igb_get_flex_filter(struct rte_eth_dev *dev, struct rte_eth_flex_filter *filter) {
    ...
    flex_filter.filter_info.priority = filter->priority;
    memcpy(flex_filter.filter_info.dwords, filter->bytes, filter->len);
    memcpy(flex_filter.filter_info.mask, filter->mask, RTE_ALIGN(filter->len, CHAR_BIT) / CHAR_BIT);
    ...
    if ((wufc & wufc_en) == wufc_en) {
        ...
        filter->queue = (queueing & E1000_FHFT_QUEUEING_QUEUE) >> E1000_FHFT_QUEUEING_QUEUE_SHIFT;
        return 0;
    }
    return -ENOENT;
}
...
static int eth_igb_flex_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg) {
    ...
    if (filter->len == 0 || filter->len > E1000_MAX_FLEX_FILTER_LEN || filter->len % sizeof(uint64_t) != 0) {
...
static inline int ntuple_filter_to_5tuple_82576(struct rte_eth_ntuple_filter *filter,
...
static inline struct e1000_5tuple_filter *igb_5tuple_filter_lookup_82576(struct e1000_5tuple_filter_list *filter_list,
                                                                         struct e1000_5tuple_filter_info *key) {
    struct e1000_5tuple_filter *it;

    TAILQ_FOREACH(it, filter_list, entries) {
        if (memcmp(key, &it->filter_info, sizeof(struct e1000_5tuple_filter_info)) == 0) {
            return it;
        }
    }
    return NULL;
...
static inline void igb_inject_5tuple_filter_82576(struct rte_eth_dev *dev, struct e1000_5tuple_filter *filter) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int igb_add_5tuple_filter_82576(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter) {
    ...
    filter = rte_zmalloc("e1000_5tuple_filter", sizeof(struct e1000_5tuple_filter), 0);
    if (filter == NULL)
        return -ENOMEM;
    ...
    if (igb_5tuple_filter_lookup_82576(&filter_info->fivetuple_list, &filter->filter_info) != NULL) {
        PMD_DRV_LOG(ERR, "filter exists.");
        rte_free(filter);
        return -EEXIST;
    }
...
int igb_delete_5tuple_filter_82576(struct rte_eth_dev *dev, struct e1000_5tuple_filter *filter) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
    ...
    E1000_WRITE_REG(hw, E1000_FTQF(filter->index), E1000_FTQF_VF_BP | E1000_FTQF_MASK);
...
static int igb_remove_5tuple_filter_82576(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter) {
    ...
    filter = igb_5tuple_filter_lookup_82576(&filter_info->fivetuple_list, &filter_5tuple);
    if (filter == NULL) {
        PMD_DRV_LOG(ERR, "filter doesn't exist.");
        return -ENOENT;
    }
...
static int eth_igb_mtu_set(struct rte_eth_dev *dev, uint16_t mtu) {
    ...
    if (!dev->data->scattered_rx && frame_size > dev->data->min_rx_buf_size - RTE_PKTMBUF_HEADROOM)
        return -EINVAL;
    ...
    E1000_WRITE_REG(hw, E1000_RLPML, dev->data->dev_conf.rxmode.max_rx_pkt_len);
 ...
 *    - On failure, a negative value.
 */
int igb_add_del_ntuple_filter(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter, bool add) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    int ret;
    ...
    case (RTE_2TUPLE_FLAGS | RTE_NTUPLE_FLAGS_TCP_FLAG):
        if (hw->mac.type != e1000_82580 && hw->mac.type != e1000_i350 && hw->mac.type != e1000_i210 &&
 ...
 *    - On failure, a negative value.
 */
static int igb_get_ntuple_filter(struct rte_eth_dev *dev, struct rte_eth_ntuple_filter *ntuple_filter) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
    struct e1000_5tuple_filter_info filter_5tuple;
    struct e1000_2tuple_filter_info filter_2tuple;
    ...
    case (RTE_5TUPLE_FLAGS | RTE_NTUPLE_FLAGS_TCP_FLAG):
        ...
        if (ret < 0)
            return ret;
        p_5tuple_filter = igb_5tuple_filter_lookup_82576(&filter_info->fivetuple_list, &filter_5tuple);
    ...
    case (RTE_2TUPLE_FLAGS | RTE_NTUPLE_FLAGS_TCP_FLAG):
        ...
        if (ret < 0)
            return ret;
        p_2tuple_filter = igb_2tuple_filter_lookup(&filter_info->twotuple_list, &filter_2tuple);
...
static int igb_ntuple_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg) {
    ...
    switch (filter_op) {
    case RTE_ETH_FILTER_ADD:
        ret = igb_add_del_ntuple_filter(dev, (struct rte_eth_ntuple_filter *)arg, TRUE);
        break;
    case RTE_ETH_FILTER_DELETE:
        ret = igb_add_del_ntuple_filter(dev, (struct rte_eth_ntuple_filter *)arg, FALSE);
        break;
    case RTE_ETH_FILTER_GET:
        ret = igb_get_ntuple_filter(dev, (struct rte_eth_ntuple_filter *)arg);
        break;
    default:
        PMD_DRV_LOG(ERR, "unsupported operation %u.", filter_op);
        ret = -EINVAL;
...
static inline int igb_ethertype_filter_lookup(struct e1000_filter_info *filter_info, uint16_t ethertype) {
    int i;

    for (i = 0; i < E1000_MAX_ETQF_FILTERS; i++) {
        if (filter_info->ethertype_filters[i].ethertype == ethertype && (filter_info->ethertype_mask & (1 << i)))
            return i;
    }
    return -1;
}

static inline int igb_ethertype_filter_insert(struct e1000_filter_info *filter_info, uint16_t ethertype,
                                              uint32_t etqf) {
    int i;
...
int igb_ethertype_filter_remove(struct e1000_filter_info *filter_info, uint8_t idx) {
...
int igb_add_del_ethertype_filter(struct rte_eth_dev *dev, struct rte_eth_ethertype_filter *filter, bool add) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_filter_info *filter_info = E1000_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
    uint32_t etqf = 0;
    int ret;
...
static int igb_get_ethertype_filter(struct rte_eth_dev *dev, struct rte_eth_ethertype_filter *filter) {
    ...
    if (etqf & E1000_ETQF_FILTER_ENABLE) {
        ...
        filter->flags = 0;
        filter->queue = (etqf & E1000_ETQF_QUEUE) >> E1000_ETQF_QUEUE_SHIFT;
        return 0;
    }
...
static int igb_ethertype_filter_handle(struct rte_eth_dev *dev, enum rte_filter_op filter_op, void *arg) {
    ...
    switch (filter_op) {
    case RTE_ETH_FILTER_ADD:
        ret = igb_add_del_ethertype_filter(dev, (struct rte_eth_ethertype_filter *)arg, TRUE);
        break;
    case RTE_ETH_FILTER_DELETE:
        ret = igb_add_del_ethertype_filter(dev, (struct rte_eth_ethertype_filter *)arg, FALSE);
        break;
    case RTE_ETH_FILTER_GET:
        ret = igb_get_ethertype_filter(dev, (struct rte_eth_ethertype_filter *)arg);
        break;
    default:
        PMD_DRV_LOG(ERR, "unsupported operation %u.", filter_op);
        ret = -EINVAL;
...
static uint64_t igb_read_systime_cyclecounter(struct rte_eth_dev *dev) {
    ...
    case e1000_i211:
        ...
        systime_cycles += (uint64_t)E1000_READ_REG(hw, E1000_SYSTIMH) * NSEC_PER_SEC;
        break;
    case e1000_82580:
    case e1000_i350:
    case e1000_i354:
        ...
        systime_cycles |= (uint64_t)(E1000_READ_REG(hw, E1000_SYSTIMH) & 0xff) << 32;
        break;
    default:
        systime_cycles = (uint64_t)E1000_READ_REG(hw, E1000_SYSTIML);
...
static uint64_t igb_read_rx_tstamp_cyclecounter(struct rte_eth_dev *dev) {
    ...
    case e1000_i211:
        ...
        rx_tstamp_cycles += (uint64_t)E1000_READ_REG(hw, E1000_RXSTMPH) * NSEC_PER_SEC;
        break;
    case e1000_82580:
    case e1000_i350:
    case e1000_i354:
        rx_tstamp_cycles = (uint64_t)E1000_READ_REG(hw, E1000_RXSTMPL);
        /* Only the 8 LSB are valid. */
        rx_tstamp_cycles |= (uint64_t)(E1000_READ_REG(hw, E1000_RXSTMPH) & 0xff) << 32;
        break;
    default:
        rx_tstamp_cycles = (uint64_t)E1000_READ_REG(hw, E1000_RXSTMPL);
...
static uint64_t igb_read_tx_tstamp_cyclecounter(struct rte_eth_dev *dev) {
    ...
    case e1000_i211:
        ...
        tx_tstamp_cycles += (uint64_t)E1000_READ_REG(hw, E1000_TXSTMPH) * NSEC_PER_SEC;
        break;
    case e1000_82580:
    case e1000_i350:
    case e1000_i354:
        tx_tstamp_cycles = (uint64_t)E1000_READ_REG(hw, E1000_TXSTMPL);
        /* Only the 8 LSB are valid. */
        tx_tstamp_cycles |= (uint64_t)(E1000_READ_REG(hw, E1000_TXSTMPH) & 0xff) << 32;
        break;
    default:
        tx_tstamp_cycles = (uint64_t)E1000_READ_REG(hw, E1000_TXSTMPL);
...
static int igb_timesync_write_time(struct rte_eth_dev *dev, const struct timespec *ts) {
    uint64_t ns;
    struct e1000_adapter *adapter = (struct e1000_adapter *)dev->data->dev_private;
...
static int igb_timesync_read_time(struct rte_eth_dev *dev, struct timespec *ts) {
...
static int igb_timesync_enable(struct rte_eth_dev *dev) {
    ...
    E1000_WRITE_REG(hw, E1000_ETQF(E1000_ETQF_FILTER_1588),
                    (ETHER_TYPE_1588 | E1000_ETQF_FILTER_ENABLE | E1000_ETQF_1588));
...
static int igb_timesync_read_rx_timestamp(struct rte_eth_dev *dev, struct timespec *timestamp,
...
static int eth_igb_get_regs(struct rte_eth_dev *dev, struct rte_dev_reg_info *regs) {
    ...
    if ((regs->length == 0) || (regs->length == (uint32_t)eth_igb_get_reg_length(dev))) {
...
static int igbvf_get_regs(struct rte_eth_dev *dev, struct rte_dev_reg_info *regs) {
    ...
    /* Support only full register dump */
    if ((regs->length == 0) || (regs->length == (uint32_t)igbvf_get_reg_length(dev))) {
        regs->version = hw->mac.type << 24 | hw->revision_id << 16 | hw->device_id;
        while ((reg_group = igbvf_regs[g_ind++]))
            count += igb_read_regs_group(dev, &data[count], reg_group);
        return 0;
...
static int eth_igb_get_eeprom(struct rte_eth_dev *dev, struct rte_dev_eeprom_info *in_eeprom) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int eth_igb_set_eeprom(struct rte_eth_dev *dev, struct rte_dev_eeprom_info *in_eeprom) {
    struct e1000_hw *hw = E1000_DEV_PRIVATE_TO_HW(dev->data->dev_private);
    struct e1000_nvm_info *nvm = &hw->nvm;
    uint16_t *data = in_eeprom->data;
    int first, length;
...
static int eth_igb_get_module_info(struct rte_eth_dev *dev, struct rte_eth_dev_module_info *modinfo) {
    ...
    if (hw->phy.media_type == e1000_media_type_copper || hw->phy.media_type == e1000_media_type_unknown)
        return -EOPNOTSUPP;
...
static void eth_igb_assign_msix_vector(struct e1000_hw *hw, int8_t direction, uint8_t queue, uint8_t msix_vector) {
    ...
    if (hw->mac.type == e1000_82575) {
        ...
        if ((direction == 0) || (direction == 1))
            eth_igb_write_ivar(hw, msix_vector, queue & 0x7, ((queue & 0x8) << 1) + 8 * direction);
    } else if ((hw->mac.type == e1000_82580) || (hw->mac.type == e1000_i350) || (hw->mac.type == e1000_i354) ||
               (hw->mac.type == e1000_i210) || (hw->mac.type == e1000_i211)) {
        if ((direction == 0) || (direction == 1))
            eth_igb_write_ivar(hw, msix_vector, queue >> 1, ((queue & 0x1) << 4) + 8 * direction);
    }
}
...
static void eth_igb_configure_msix_intr(struct rte_eth_dev *dev) {
    ...
    } else if ((hw->mac.type == e1000_82576) || (hw->mac.type == e1000_82580) || (hw->mac.type == e1000_i350) ||
               (hw->mac.type == e1000_i354) || (hw->mac.type == e1000_i210) || (hw->mac.type == e1000_i211)) {
        /* turn on MSI-X capability first */
        E1000_WRITE_REG(hw, E1000_GPIE, E1000_GPIE_MSIX_MODE | E1000_GPIE_PBA | E1000_GPIE_EIAME | E1000_GPIE_NSICR);
        intr_mask = RTE_LEN2MASK(intr_handle->nb_efd, uint32_t) << misc_shift;
...
static inline void igb_ntuple_filter_restore(struct rte_eth_dev *dev) {
    ...
    TAILQ_FOREACH(p_5tuple, &filter_info->fivetuple_list, entries) { igb_inject_5tuple_filter_82576(dev, p_5tuple); }

    TAILQ_FOREACH(p_2tuple, &filter_info->twotuple_list, entries) { igb_inject_2uple_filter(dev, p_2tuple); }
}
...
static inline void igb_ethertype_filter_restore(struct rte_eth_dev *dev) {
    ...
    for (i = 0; i < E1000_MAX_ETQF_FILTERS; i++) {
        if (filter_info->ethertype_mask & (1 << i)) {
            E1000_WRITE_REG(hw, E1000_ETQF(i), filter_info->ethertype_filters[i].etqf);
            E1000_WRITE_FLUSH(hw);
        }
    }
}
...
static inline void igb_flex_filter_restore(struct rte_eth_dev *dev) {
    ...
    TAILQ_FOREACH(flex_filter, &filter_info->flex_list, entries) { igb_inject_flex_filter(dev, flex_filter); }
}
...
/* see e1000_logs.c */
RTE_INIT(e1000_init_log) { e1000_igb_init_log(); }
