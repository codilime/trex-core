 ...
 **/
enum i40e_status_code i40e_diag_set_loopback(struct i40e_hw *hw, enum i40e_lb_mode mode) {
 ...
 **/
static enum i40e_status_code i40e_diag_reg_pattern_test(struct i40e_hw *hw, u32 reg, u32 mask) {
...
enum i40e_status_code i40e_diag_reg_test(struct i40e_hw *hw) {
    ...
    for (i = 0; i40e_reg_list[i].offset != 0 && ret_code == I40E_SUCCESS; i++) {
        ...
        if (i40e_reg_list[i].offset == I40E_QTX_CTL(0) && hw->func_caps.num_tx_qp != 0)
            i40e_reg_list[i].elements = hw->func_caps.num_tx_qp;
        if ((i40e_reg_list[i].offset == I40E_PFINT_ITRN(0, 0) || i40e_reg_list[i].offset == I40E_PFINT_ITRN(1, 0) ||
             i40e_reg_list[i].offset == I40E_PFINT_ITRN(2, 0) || i40e_reg_list[i].offset == I40E_QINT_TQCTL(0) ||
...
enum i40e_status_code i40e_diag_eeprom_test(struct i40e_hw *hw) {
    ...
    if ((ret_code == I40E_SUCCESS) && ((reg_val & I40E_SR_CONTROL_WORD_1_MASK) == BIT(I40E_SR_CONTROL_WORD_1_SHIFT)))
