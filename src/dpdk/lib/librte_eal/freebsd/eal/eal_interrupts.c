...
static int intr_source_to_kevent(const struct rte_intr_handle *ih, struct kevent *ke) {
...
void rte_intr_efd_disable(struct rte_intr_handle *intr_handle) { RTE_SET_USED(intr_handle); }
...
void rte_intr_free_epoll_fd(struct rte_intr_handle *intr_handle) { RTE_SET_USED(intr_handle); }
