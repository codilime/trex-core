 ...
 * into a list of valid keys.
 */
static int check_for_valid_keys(struct rte_kvargs *kvlist, const char *const valid[]) {
    unsigned i, ret;
...
__rte_experimental struct rte_kvargs *rte_kvargs_parse_delim(const char *args, const char *const valid_keys[],
...
__rte_experimental int rte_kvargs_strcmp(const char *key __rte_unused, const char *value, void *opaque) {
