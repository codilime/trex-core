...
#define RTE_PORT_ETHDEV_READER_STATS_PKTS_IN_ADD(port, val) port->stats.n_pkts_in += val
#define RTE_PORT_ETHDEV_READER_STATS_PKTS_DROP_ADD(port, val) port->stats.n_pkts_drop += val
...
static int rte_port_ethdev_reader_rx(void *port, struct rte_mbuf **pkts, uint32_t n_pkts) {
...
static int rte_port_ethdev_reader_stats_read(void *port, struct rte_port_in_stats *stats, int clear) {
    struct rte_port_ethdev_reader *p = port;
...
#define RTE_PORT_ETHDEV_WRITER_STATS_PKTS_IN_ADD(port, val) port->stats.n_pkts_in += val
#define RTE_PORT_ETHDEV_WRITER_STATS_PKTS_DROP_ADD(port, val) port->stats.n_pkts_drop += val
...
static int rte_port_ethdev_writer_tx_bulk(void *port, struct rte_mbuf **pkts, uint64_t pkts_mask) {
    struct rte_port_ethdev_writer *p = port;
...
static int rte_port_ethdev_writer_stats_read(void *port, struct rte_port_out_stats *stats, int clear) {
    struct rte_port_ethdev_writer *p = port;
...
#define RTE_PORT_ETHDEV_WRITER_NODROP_STATS_PKTS_IN_ADD(port, val) port->stats.n_pkts_in += val
#define RTE_PORT_ETHDEV_WRITER_NODROP_STATS_PKTS_DROP_ADD(port, val) port->stats.n_pkts_drop += val
...
static inline void send_burst_nodrop(struct rte_port_ethdev_writer_nodrop *p) {
    ...
    for (i = 0; i < p->n_retries; i++) {
        nb_tx += rte_eth_tx_burst(p->port_id, p->queue_id, p->tx_buf + nb_tx, p->tx_buf_count - nb_tx);
...
static int rte_port_ethdev_writer_nodrop_tx_bulk(void *port, struct rte_mbuf **pkts, uint64_t pkts_mask) {
    struct rte_port_ethdev_writer_nodrop *p = port;
...
static int rte_port_ethdev_writer_nodrop_stats_read(void *port, struct rte_port_out_stats *stats, int clear) {
    struct rte_port_ethdev_writer_nodrop *p = port;
