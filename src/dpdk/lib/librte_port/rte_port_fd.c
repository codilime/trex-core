...
static int rte_port_fd_reader_rx(void *port, struct rte_mbuf **pkts, uint32_t n_pkts) {
...
static int rte_port_fd_reader_stats_read(void *port, struct rte_port_in_stats *stats, int clear) {
    struct rte_port_fd_reader *p = port;
...
static int rte_port_fd_writer_tx_bulk(void *port, struct rte_mbuf **pkts, uint64_t pkts_mask) {
    struct rte_port_fd_writer *p = port;
...
static int rte_port_fd_writer_stats_read(void *port, struct rte_port_out_stats *stats, int clear) {
    struct rte_port_fd_writer *p = port;
...
static int rte_port_fd_writer_nodrop_tx_bulk(void *port, struct rte_mbuf **pkts, uint64_t pkts_mask) {
    struct rte_port_fd_writer_nodrop *p = port;
    uint32_t tx_buf_count = p->tx_buf_count;
...
static int rte_port_fd_writer_nodrop_stats_read(void *port, struct rte_port_out_stats *stats, int clear) {
    struct rte_port_fd_writer_nodrop *p = port;
