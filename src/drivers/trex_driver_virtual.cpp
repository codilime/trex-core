...
std::string &get_mlx4_so_string(void) { return CTRexExtendedDriverMlnx4::mlx4_so_str; }
...
int CTRexExtendedDriverVirtBase::get_min_sample_rate(void) { return (RX_CHECK_MIX_SAMPLE_RATE_1G); }

void CTRexExtendedDriverVirtBase::get_rx_stat_capabilities(uint16_t &flags, uint16_t &num_counters,
                                                           uint16_t &base_ip_id) {
    flags =
...
int CTRexExtendedDriverVirtBase::configure_rx_filter_rules(CPhyEthIF *_if) { return (0); }
...
int CTRexExtendedDriverVirtBase::stop_queue(CPhyEthIF *_if, uint16_t q_num) { return (0); }
...
CTRexExtendedDriverVirtio::CTRexExtendedDriverVirtio() { m_cap = tdCAP_ONE_QUE | tdCAP_MULTI_QUE; }
...
CTRexExtendedDriverVmxnet3::CTRexExtendedDriverVmxnet3() { m_cap = tdCAP_ONE_QUE | tdCAP_MULTI_QUE; }
...
CTRexExtendedDriverAfPacket::CTRexExtendedDriverAfPacket() { m_cap = tdCAP_ONE_QUE; }
...
CTRexExtendedDriverI40evf::CTRexExtendedDriverI40evf() { m_cap = tdCAP_ONE_QUE | tdCAP_MULTI_QUE; }
...
CTRexExtendedDriverIxgbevf::CTRexExtendedDriverIxgbevf() { m_cap = tdCAP_ONE_QUE | tdCAP_MULTI_QUE; }
