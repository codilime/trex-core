...
void tw_on_tick_cb_test1(void *userdata, CHTimerObj *tmr) {
...
void CHTimerWheelTest1::Delete() { assert(m_timer.Delete() == RC_HTW_OK); }

TEST_F(gt_r_timer, timer8) {

    CHTimerWheelTest1 test;

    CHTimerWheelTest1Cfg cfg = {.m_wheel_size = 4,
                                .m_num_wheels = 4,
                                .m_start_tick = 2,
                                .m_restart_tick = 2,
                                .m_total_ticks = 100,
...
TEST_F(gt_r_timer, timer9) {
    ...
    CHTimerWheelTest1Cfg cfg = {
        .m_wheel_size = 4, .m_num_wheels = 4, .m_start_tick = 4, .m_restart_tick = 2, .m_total_ticks = 20};
    test.Create(cfg);
    test.start_test();
    test.Delete();
}
...
TEST_F(gt_r_timer, timer10) {
    ...
    CHTimerWheelTest1Cfg cfg = {
        .m_wheel_size = 4, .m_num_wheels = 4, .m_start_tick = 80, .m_restart_tick = 9, .m_total_ticks = 100};
    test.Create(cfg);
    test.start_test();
    test.Delete();
}
...
TEST_F(gt_r_timer, timer_verylog) {
    ...
    CHTimerWheelTest1 test;
    CHTimerWheelTest1Cfg cfg = {
        .m_wheel_size = 4, .m_num_wheels = 2, .m_start_tick = 30, .m_restart_tick = 40, .m_total_ticks = 100,
        //.m_verbose =true,
        //.m_dont_assert=true
...
void CHTimerWheelTest2::Delete() { assert(m_timer.Delete() == RC_HTW_OK); }
...
TEST_F(gt_r_timer, timer13) {
    ...
    CHTimerWheelTest2Cfg cfg = {.m_wheel_size = 4,
                                .m_num_wheels = 4,
...
TEST_F(gt_r_timer, timer14) {
    ...
    CHTimerWheelTest2 test;
    CHTimerWheelTest2Cfg cfg = {.m_wheel_size = 8,
                                .m_num_wheels = 3,
                                .m_number_of_con_event = 10,
                                .m_total_ticks = 1000,
                                .m_random = false,
...
TEST_F(gt_r_timer, timer15) {
    ...
    CHTimerWheelTest2 test;
    CHTimerWheelTest2Cfg cfg = {.m_wheel_size = 1024,
                                .m_num_wheels = 3,
...
TEST_F(gt_r_timer, timer16) {
    ...
    CHTimerWheelTest2 test;
    CHTimerWheelTest2Cfg cfg = {.m_wheel_size = 32,
                                .m_num_wheels = 4,
...
TEST_F(gt_r_timer, timer18) {
    ...
    RC_HTW_t res[] = {RC_HTW_OK,          RC_HTW_ERR_NO_RESOURCES, RC_HTW_ERR_TIMER_IS_ON,
                      RC_HTW_ERR_NO_LOG2, RC_HTW_ERR_MAX_WHEELS,   RC_HTW_ERR_NOT_ENOUGH_BITS};
...
TEST_F(gt_r_timer, timer20) {
    ...
    CNATimerWheelTest1Cfg cfg = {.m_wheel_size = 32,
                                 .m_level1_div = 4,
                                 .m_start_tick = 2,
                                 .m_restart_tick = 2,
                                 .m_total_ticks = 1024,
...
void CNATimerWheelTest2::Delete() { assert(m_timer.Delete() == RC_HTW_OK); }
...
TEST_F(gt_r_timer, timer30) {
    ...
    CNATimerWheelTest2Cfg cfg = {.m_wheel_size = 32,
                                 .m_level1_div = 4,
                                 .m_number_of_con_event = 100,
                                 .m_total_ticks = 1000,
                                 .m_random = false,
...
TEST_F(gt_r_timer, timer34) {
    ...
    for (i = 0; i < 2500; i++) {
        ...
        m_timer.on_tick_level_count(1, (void *)&m_timer, my_test_on_tick_cb19, 32,
                                    left); // call the callback of second level
    }
    delete[] m_events;
