...
static inline double usec_to_sec(double usec) { return (usec / (1000 * 1000)); }
...
static inline hr_time_t os_get_hr_tick_64(void) { return (rte_rdtsc()); }

static inline hr_time_32_t os_get_hr_tick_32(void) { return ((uint32_t)os_get_hr_tick_64()); }

static inline hr_time_t os_get_hr_freq(void) { return (rte_get_tsc_hz()); }
...
static inline hr_time_t os_get_hr_freq(void) { return (3000000000ULL); }
...
static inline uint32_t os_get_hr_tick_32(void) { return (platform_time_get_highres_tick_32()); }
...
/* convert delta time */
static inline hr_time_t ptime_convert_dsec_hr(dsec_t dsec) { return ((hr_time_t)(dsec * timer_gd.m_freq)); }

/* convert delta time */
static inline dsec_t ptime_convert_hr_dsec(hr_time_t hrt) { return ((dsec_t)((double)hrt * timer_gd.m_1_div_freq)); }
...
static inline void delay(int msec) {
    ...
    if (msec == 0) { // user that requested that probebly wanted the minimal delay
...
static inline void delay_sec(dsec_t sec) {
    struct timespec time1, remain; // 2 sec max delay
 ...
 *
 */
static inline void delay_spin(double sec) {
