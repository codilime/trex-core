...
void CPlatformMemoryYamlInfo::limit_lowend() {
    ...
    pool_sizes pools[] = {
        {MBUF_64, CONST_SMALL_MBUF_SIZE},          {MBUF_128, CONST_128_MBUF_SIZE},
        {MBUF_256, CONST_256_MBUF_SIZE},           {MBUF_512, CONST_512_MBUF_SIZE},
        {MBUF_1024, CONST_1024_MBUF_SIZE},         {MBUF_2048, CONST_2048_MBUF_SIZE},
        {MBUF_4096, CONST_4096_MBUF_SIZE},         {MBUF_9k, CONST_9k_MBUF_SIZE},
        {TRAFFIC_MBUF_64, CONST_SMALL_MBUF_SIZE},  {TRAFFIC_MBUF_128, CONST_128_MBUF_SIZE},
        {TRAFFIC_MBUF_256, CONST_256_MBUF_SIZE},   {TRAFFIC_MBUF_512, CONST_512_MBUF_SIZE},
        {TRAFFIC_MBUF_1024, CONST_1024_MBUF_SIZE}, {TRAFFIC_MBUF_2048, CONST_2048_MBUF_SIZE},
        {TRAFFIC_MBUF_4096, CONST_4096_MBUF_SIZE}, {TRAFFIC_MBUF_9k, CONST_9k_MBUF_SIZE},
    };
...
const std::string names[] = {"MBUF_64",           "MBUF_128",          "MBUF_256",          "MBUF_512",
                             "MBUF_1024",         "MBUF_2048",         "MBUF_4096",         "MBUF_9K",

                             "TRAFFIC_MBUF_64",   "TRAFFIC_MBUF_128",  "TRAFFIC_MBUF_256",  "TRAFFIC_MBUF_512",
                             "TRAFFIC_MBUF_1024", "TRAFFIC_MBUF_2048", "TRAFFIC_MBUF_4096", "TRAFFIC_MBUF_9K",

                             "MBUF_DP_FLOWS",     "MBUF_GLOBAL_FLOWS"

};

const std::string *get_mbuf_names(void) { return names; }
...
uint32_t CMacYamlInfo::get_def_gw() { return m_def_gw; }

uint32_t CMacYamlInfo::get_ip() { return m_ip; }

uint32_t CMacYamlInfo::get_mask() { return m_mask; }

uint32_t CMacYamlInfo::get_vlan() { return m_vlan; }
