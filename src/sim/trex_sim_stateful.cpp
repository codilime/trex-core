...
void update_tcp_seq_num(CCapFileFlowInfo *obj, int pkt_id, int size_change) {
...
void CMergeCapFileRec::Delete() { m_cap.Delete(); }

bool CMergeCapFileRec::Create(std::string cap_file, double offset) {
    m_cap.Create();
...
void CMergeCapFile::Delete() { m_results.Delete(); }
