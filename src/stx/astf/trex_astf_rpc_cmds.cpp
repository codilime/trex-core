...
TrexAstfPort *get_astf_port(uint8_t port_id) { return (TrexAstfPort *)get_stx()->get_port_by_id(port_id); }
...
#define TREX_RPC_CMD_ASTF_DEFINE_EXTENDED(class_name, cmd_name, needs_api, needs_ownership, ext)                       \
    class class_name : public TrexRpcAstfCommand {                                                                     \
      public:                                                                                                          \
        class_name(TrexRpcComponent *component)                                                                        \
            : TrexRpcAstfCommand(cmd_name, component, needs_api, needs_ownership) {}                                   \
                                                                                                                       \
      protected:                                                                                                       \
 ...
 */
#define TREX_RPC_CMD_ASTF_OWNED(class_name, cmd_name)                                                                  \
    TREX_RPC_CMD_ASTF_DEFINE_EXTENDED(class_name, cmd_name, true, true, ;)
#define TREX_RPC_CMD_ASTF_OWNED_EXT(class_name, cmd_name, ext)                                                         \
    TREX_RPC_CMD_ASTF_DEFINE_EXTENDED(class_name, cmd_name, true, true, ext)
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfSync::_run(const Json::Value &params, Json::Value &result) {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfIncEpoch::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
    TrexAstf *stx = get_astf_object();
    try {
        stx->inc_epoch();
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfAcquire::_run(const Json::Value &params, Json::Value &result) {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfRelease::_run(const Json::Value &params, Json::Value &result) {
    get_astf_object()->release_context();

    return (TREX_RPC_CMD_OK);
}

trex_rpc_cmd_rc_e TrexRpcCmdAstfProfileFragment::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfProfileClear::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
    try {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfStart::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
    start_params_t args;
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfStop::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
    try {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfUpdate::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfProfileList::_run(const Json::Value &params, Json::Value &result) {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfStartLatency::_run(const Json::Value &params, Json::Value &result) {
    ...
    for (auto &port : get_astf_object()->get_port_map()) {
        ...
        for (uint8_t dual_port_id = 0; dual_port_id <= (max_port_id / 2); dual_port_id++) {
            if (port_ip_num == dst_ip + dual_port_id * dual_ip) {
                string err =
                    "Latency dst IP and dual_port might reach port " + to_string(port.first) + " with IP " + ip_str;
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfStopLatency::_run(const Json::Value &params, Json::Value &result) {
    bool stopped = true;
    try {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfUpdateLatency::_run(const Json::Value &params, Json::Value &result) {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfGetLatencyStats::_run(const Json::Value &params, Json::Value &result) {
    try {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfGetTrafficDist::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfCountersDesc::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
    TrexAstf *stx = get_astf_object();
    if (!stx->is_valid_profile(profile_id)) {
        generate_execute_err(result, "Invalid profile : " + profile_id);
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfCountersValues::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
    TrexAstf *stx = get_astf_object();
    if (!stx->is_valid_profile(profile_id)) {
        generate_execute_err(result, "Invalid profile : " + profile_id);
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfTotalCountersValues::_run(const Json::Value &params, Json::Value &result) {
    TrexAstf *stx = get_astf_object();
    ...
    for (auto lpstt : sttcp_list) {
        if (lpstt->m_init) {
            ...
            for (auto i : temp.getMemberNames()) {
                ...
                if (total_pps > 0.0) {
                    entry[i][avg_size] = (entry[i][tx_bw].asDouble() + entry[i][rx_bw].asDouble()) / (8.0 * total_pps);
                }
                if (total_tx_bw > 0.0) {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfGetTGNames::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
    TrexAstf *stx = get_astf_object();
    if (!stx->is_valid_profile(profile_id)) {
        generate_execute_err(result, "Invalid profile : " + profile_id);
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfGetTGStats::_run(const Json::Value &params, Json::Value &result) {
    string profile_id = parse_profile(params, result);
        ...
        if (lpstt && lpstt->m_init) {
            for (auto &itr : tgids) {
                ...
                if (tg_id > lpstt->m_num_of_tg_ids) {
                    generate_execute_err(result, "TG ID is too big. Max value is " + to_string(lpstt->m_num_of_tg_ids) +
                                                     ". Received " + to_string(tg_id));
                }
                if (tg_id == 0) {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfTopoGet::_run(const Json::Value &params, Json::Value &result) {
    try {
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfTopoFragment::_run(const Json::Value &params, Json::Value &result) {
    const bool frag_first = parse_bool(params, "frag_first", result, false);
    const bool frag_last = parse_bool(params, "frag_last", result, false);
...
trex_rpc_cmd_rc_e TrexRpcCmdAstfTopoClear::_run(const Json::Value &params, Json::Value &result) {
    try {
