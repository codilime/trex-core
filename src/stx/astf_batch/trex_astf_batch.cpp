...
TrexDpCoreAstfBatch::~TrexDpCoreAstfBatch(void) { m_core->Delete_tcp_ctx(); }

void TrexDpCoreAstfBatch::start_astf() {
    dsec_t d_time_flow;
...
void TrexAstfBatch::publish_async_data() {
    std::string json;
