...
void CRpcTunnelCStackBase::init(CStackBase *obj) { m_obj = obj; }
...
void CRpcTunnelCStackBase::update_cmd_count(uint32_t total_exec_commands, uint32_t err_exec_commands) {
...
CNodeBase *CStackBase::get_node(const string &mac_buf) { return get_node_internal(mac_buf); }
...
bool CStackBase::has_capa(capa_enum capa) { return get_capa() & capa; }
...
void CStackBase::update_rcp_cmds_count(uint32_t total_exec_commands, uint32_t err_commands) {
...
bool CStackBase::is_running_tasks() { return m_is_running_tasks; }
...
// getters
bool CNodeBase::is_dst_mac_valid() { return m_dst_mac_valid; }

bool CNodeBase::is_loopback() { return m_is_loopback; }

bool CNodeBase::is_ip6_enabled() { return m_ip6_enabled; }
...
std::string CNodeBase::get_src_mac_as_str() { return (utl_macaddr_to_str((uint8_t *)get_src_mac().data())); }

const string &CNodeBase::get_src_mac() { return m_src_mac; }

const string &CNodeBase::get_dst_mac() { return m_dst_mac; }

const vlan_list_t &CNodeBase::get_vlan_tags() { return m_vlan_tags; }

const vlan_list_t &CNodeBase::get_vlan_tpids() { return m_vlan_tpids; }

const string &CNodeBase::get_src_ip4() { return m_ip4; }

const string &CNodeBase::get_dst_ip4() { return m_gw4; }

const string &CNodeBase::get_src_ip6() { return m_ip6; }
