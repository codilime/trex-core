...
#define RX_S_ADD_CNT(f, sf, help)                                                                                      \
    { create_sc(&m_clm, #sf, help, &f, false, false); }
// for errors
#define RX_S_ADD_CNT_E(f, sf, help)                                                                                    \
    { create_sc(&m_clm, #sf, help, &f, false, true); }
...
void CRxCounters::dump() { m_tbl.dump_table(stdout, false, true); }
...
void CRxCounters::dump_meta(std::string name, Json::Value &json) { m_tbl.dump_meta(name, json); }

void CRxCounters::dump_values(std::string name, bool zeros, Json::Value &obj) {
