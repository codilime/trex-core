...
TREX_RPC_CMD_OWNED_EXT(
    TrexRpcCmdAddStream, "add_stream",

    /* extended part */
    std::unique_ptr<TrexStream> allocate_new_stream(const Json::Value &section, uint8_t port_id, uint32_t stream_id,
                                                    Json::Value &result);
    ...
    void parse_vm_instr_flow_var_rand_limit(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                            Json::Value &result);
    void check_min_max(uint8_t flow_var_size, uint64_t init_value, uint64_t step, uint64_t min_value,
                       uint64_t max_value, Json::Value &result);
    void check_value_list(uint8_t flow_var_size, uint64_t step, std::vector<uint64_t> value_list, Json::Value &result);

    void parse_vm_instr_tuple_flow_var(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                       Json::Value &result);
    void parse_vm_instr_trim_pkt_size(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                      Json::Value &result);
    void parse_rate(const Json::Value &inst, std::unique_ptr<TrexStream> &stream, Json::Value &result);
    void parse_vm_instr_write_flow_var(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                       Json::Value &result);
    void parse_vm_instr_write_mask_flow_var(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                            Json::Value &result);
 ...
 *
 */
trex_rpc_cmd_rc_e TrexRpcCmdAcquire::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 */
trex_rpc_cmd_rc_e TrexRpcCmdRelease::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 */
trex_rpc_cmd_rc_e TrexRpcCmdGetActivePGIds::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 */
trex_rpc_cmd_rc_e TrexRpcCmdGetPGIdsStats::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdGetProfileList::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdGetStreamList::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdGetAllStreams::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdAddStream::_run(const Json::Value &params, Json::Value &result) {
    ...
    try {
        ...
        if (stream->m_core_id_specified) {
            ...
            if (core_id >= m_dp_core_count) {
                ...
                if (m_dp_core_count == 1) {
                    ...
                    ss << "Core ID is: " << core_id << ". It must be an integer between 0 and " << m_dp_core_count - 1
                       << " (inclusive).";
                }
        ...
        if ((pkt_binary.size() < MIN_PKT_SIZE) || (pkt_binary.size() > MAX_PKT_SIZE)) {
            std::stringstream ss;
            ss << "Bad packet size provided: " << pkt_binary.size() << ". Should be between " << MIN_PKT_SIZE << " and "
               << MAX_PKT_SIZE;
            generate_execute_err(result, ss.str());
        }
...
std::unique_ptr<TrexStream> TrexRpcCmdAddStream::allocate_new_stream(const Json::Value &section, uint8_t port_id,
                                                                     uint32_t stream_id, Json::Value &result) {
...
void TrexRpcCmdAddStream::parse_rate(const Json::Value &rate, std::unique_ptr<TrexStream> &stream,
                                     Json::Value &result) {
...
void TrexRpcCmdAddStream::parse_vm_instr_checksum_hw(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                                     Json::Value &result) {
...
void TrexRpcCmdAddStream::parse_vm_instr_checksum(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                                  Json::Value &result) {
...
void TrexRpcCmdAddStream::parse_vm_instr_trim_pkt_size(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                                       Json::Value &result) {
...
void TrexRpcCmdAddStream::parse_vm_instr_tuple_flow_var(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                                        Json::Value &result) {
    ...
    stream->m_vm.add_instruction(
        new StreamVmInstructionFlowClient(flow_var_name, ip_min, ip_max, port_min, port_max, limit_flows, flags));
}
 ...
 *
 */
void TrexRpcCmdAddStream::handle_range_padding(uint64_t &max_value, uint64_t &min_value, uint64_t step, int op,
                                               Json::Value &result) {
    ...
    case StreamVmInstructionFlowMan::FLOW_VAR_OP_INC:
        ...
        if ((UINT64_MAX - max_value) < step_pad) {
            generate_parse_err(
                result,
                "VM: could not pad range to be a true cycle - '(max_value - min_value + 1) % step' should be zero");
        }
        max_value += step_pad;
...
void TrexRpcCmdAddStream::check_min_max(uint8_t flow_var_size, uint64_t init_value, uint64_t step, uint64_t min_value,
                                        uint64_t max_value, Json::Value &result) {
    ...
    if (init_value < min_value || init_value > max_value) {
        std::stringstream ss;
        ss << "VM: requested flow var init value: '" << init_value << "' should be in range from min value '"
           << min_value << "' to max value '" << max_value << "'";
        generate_parse_err(result, ss.str());
    }
...
void TrexRpcCmdAddStream::check_value_list(uint8_t flow_var_size, uint64_t step, std::vector<uint64_t> value_list,
                                           Json::Value &result) {
...
void TrexRpcCmdAddStream::parse_vm_instr_flow_var_rand_limit(const Json::Value &inst,
                                                             std::unique_ptr<TrexStream> &stream, Json::Value &result) {
    std::string flow_var_name = parse_string(inst, "name", result);
    ...
    stream->m_vm.add_instruction(new StreamVmInstructionFlowRandLimit(flow_var_name, flow_var_size, limit, min_value,
                                                                      max_value, seed, is_split_needed, next_var_name));
}

void TrexRpcCmdAddStream::parse_vm_instr_flow_var(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                                  Json::Value &result) {
    std::string flow_var_name = parse_string(inst, "name", result);
    ...
    if (array == Json::Value::null) {
        ...
        stream->m_vm.add_instruction(new StreamVmInstructionFlowMan(flow_var_name, flow_var_size, op_type, init_value,
                                                                    min_value, max_value, step, is_split_needed,
                                                                    next_var_name));
    } else {
        ...
        stream->m_vm.add_instruction(new StreamVmInstructionFlowMan(flow_var_name, flow_var_size, op_type, value_list,
                                                                    step, is_split_needed, next_var_name));
    }
}

void TrexRpcCmdAddStream::parse_vm_instr_write_mask_flow_var(const Json::Value &inst,
                                                             std::unique_ptr<TrexStream> &stream, Json::Value &result) {
    std::string flow_var_name = parse_string(inst, "name", result);
    uint16_t pkt_offset = parse_uint16(inst, "pkt_offset", result);
    ...
    stream->m_vm.add_instruction(new StreamVmInstructionWriteMaskToPkt(
        flow_var_name, pkt_offset, (uint8_t)pkt_cast_size, mask, shift, add_value, is_big_endian));
}

void TrexRpcCmdAddStream::parse_vm_instr_write_flow_var(const Json::Value &inst, std::unique_ptr<TrexStream> &stream,
                                                        Json::Value &result) {
    std::string flow_var_name = parse_string(inst, "name", result);
    uint16_t pkt_offset = parse_uint16(inst, "pkt_offset", result);
    int add_value = parse_int(inst, "add_value", result);
    ...
    stream->m_vm.add_instruction(
        new StreamVmInstructionWriteToPkt(flow_var_name, pkt_offset, add_value, is_big_endian));
}

void TrexRpcCmdAddStream::parse_vm(const Json::Value &vm, std::unique_ptr<TrexStream> &stream, Json::Value &result) {
    ...
    for (int i = 0; i < instructions.size(); i++) {
        ...
        auto vm_types = {"fix_checksum_hw",     "fix_checksum_ipv4",  "flow_var",
                         "write_flow_var",      "tuple_flow_var",     "trim_pkt_size",
                         "write_mask_flow_var", "flow_var_rand_limit"};
...
void TrexRpcCmdAddStream::validate_stream(string profile_id, const std::unique_ptr<TrexStream> &stream,
                                          Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdRemoveStream::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdRemoveAllStreams::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdGetStream::_run(const Json::Value &params, Json::Value &result) {
    ...
    if (!stream) {
        std::stringstream ss;
        ss << "stream id " << stream_id << ", profile id " << profile_id << " on port " << (int)port_id
           << " does not exists";
        generate_execute_err(result, ss.str());
    }
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdStartTraffic::_run(const Json::Value &params, Json::Value &result) {
    ...
    if (get_platform_api().hw_rx_stat_supported() && port->has_flow_stats(profile_id)) {
        for (auto &port : get_stateless_obj()->get_port_map()) {
            if (port.second->is_service_mode_on()) {
                generate_execute_err(result, "Port " + to_string(port.first) +
                                                 " is under service mode, can't use flow_stats."
    ...
    if (!TrexDPCoreMask::is_valid_mask(port->get_dp_core_count(), core_mask)) {
        std::stringstream ss;
        ss << "core_mask: '0x" << std::hex << core_mask << "' for " << std::to_string(port->get_dp_core_count())
           << " cores generates an empty set";
        generate_parse_err(result, ss.str());
    }
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdStopTraffic::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdRemoveRXFilters::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdPauseTraffic::_run(const Json::Value &params, Json::Value &result) {
...
trex_rpc_cmd_rc_e TrexRpcCmdPauseStreams::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdResumeTraffic::_run(const Json::Value &params, Json::Value &result) {
...
trex_rpc_cmd_rc_e TrexRpcCmdResumeStreams::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdUpdateTraffic::_run(const Json::Value &params, Json::Value &result) {
...
trex_rpc_cmd_rc_e TrexRpcCmdUpdateStreams::_run(const Json::Value &params, Json::Value &result) {
 ...
 * valid as a program
 **************************/
trex_rpc_cmd_rc_e TrexRpcCmdValidate::_run(const Json::Value &params, Json::Value &result) {
    uint8_t port_id = parse_port(params, result);
    TrexStatelessPort *port = get_stateless_obj()->get_port_by_id(port_id);
 ...
 *
 */
trex_rpc_cmd_rc_e TrexRpcCmdPushRemote::_run(const Json::Value &params, Json::Value &result) {
 ...
 *
 */
trex_rpc_cmd_rc_e TrexRpcCmdSetServiceMode::_run(const Json::Value &params, Json::Value &result) {
    uint8_t port_id = parse_port(params, result);
    ...
    if (enabled && get_platform_api().hw_rx_stat_supported()) {
        for (auto &port : get_stateless_obj()->get_port_map()) {
            if (port.second->is_running_flow_stats()) {
                string err = "port " + to_string(port.first) +
                             " is using flow_stats."
                             " (see https://trex-tgn.cisco.com/youtrack/issue/trex-545)";
