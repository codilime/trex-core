...
class CPreviewMode {
  public:
    ...
    void setFileWrite(bool enable) { btSetMaskBit32(m_flags, 0, 0, enable ? 1 : 0); }

    bool getFileWrite() { return (btGetMaskBit32(m_flags, 0, 0) ? true : false); }

    void setDisableMbufCache(bool enable) { btSetMaskBit32(m_flags, 2, 2, enable ? 1 : 0); }

    bool isMbufCacheDisabled() { return (btGetMaskBit32(m_flags, 2, 2) ? true : false); }

    void set_disable_hw_flow_stat(bool enable) { btSetMaskBit32(m_flags, 3, 3, enable ? 1 : 0); }

    bool get_disable_hw_flow_stat() { return (btGetMaskBit32(m_flags, 3, 3) ? true : false); }

    void set_disable_flow_control_setting(bool enable) { btSetMaskBit32(m_flags, 4, 4, enable ? 1 : 0); }

    bool get_is_disable_flow_control_setting() { return (btGetMaskBit32(m_flags, 4, 4) ? true : false); }

    /* learn & verify mode  */
    void set_learn_and_verify_mode_enable(bool enable) { btSetMaskBit32(m_flags, 5, 5, enable ? 1 : 0); }

    bool get_learn_and_verify_mode_enable() { return (btGetMaskBit32(m_flags, 5, 5) ? true : false); }

    /* IPv6 enable/disable */
    void set_ipv6_mode_enable(bool enable) { btSetMaskBit32(m_flags, 7, 7, enable ? 1 : 0); }

    bool get_ipv6_mode_enable() { return (btGetMaskBit32(m_flags, 7, 7) ? true : false); }

    void setVMode(uint8_t vmode) { btSetMaskBit32(m_flags, 10, 8, vmode); }
    uint8_t getVMode() { return (btGetMaskBit32(m_flags, 10, 8)); }

    void setRealTime(bool enable) { btSetMaskBit32(m_flags, 11, 11, enable ? 1 : 0); }

    bool getRealTime() { return (btGetMaskBit32(m_flags, 11, 11) ? true : false); }

    void setClientServerFlip(bool enable) { btSetMaskBit32(m_flags, 12, 12, enable ? 1 : 0); }

    bool getClientServerFlip() { return (btGetMaskBit32(m_flags, 12, 12) ? true : false); }

    void setSingleCore(bool enable) { btSetMaskBit32(m_flags, 13, 13, enable ? 1 : 0); }

    bool getSingleCore() { return (btGetMaskBit32(m_flags, 13, 13) ? true : false); }

    /* -p */
    void setClientServerFlowFlip(bool enable) { btSetMaskBit32(m_flags, 14, 14, enable ? 1 : 0); }

    bool getClientServerFlowFlip() { return (btGetMaskBit32(m_flags, 14, 14) ? true : false); }

    void setNoCleanFlowClose(bool enable) { btSetMaskBit32(m_flags, 15, 15, enable ? 1 : 0); }

    bool getNoCleanFlowClose() { return (btGetMaskBit32(m_flags, 15, 15) ? true : false); }

    void setCores(uint8_t cores) { btSetMaskBit32(m_flags, 24, 16, cores); }

    uint8_t getCores() { return (btGetMaskBit32(m_flags, 24, 16)); }

    bool getIsOneCore() { return (getCores() == 1 ? true : false); }

    void setOnlyLatency(bool enable) { btSetMaskBit32(m_flags, 25, 25, enable ? 1 : 0); }

    bool getOnlyLatency() { return (btGetMaskBit32(m_flags, 25, 25) ? true : false); }

    void set_pcap_mode_enable(bool enable) { btSetMaskBit32(m_flags, 26, 26, enable ? 1 : 0); }

    bool get_pcap_mode_enable() { return (btGetMaskBit32(m_flags, 26, 26) ? true : false); }

    void set_zmq_publish_enable(bool enable) { btSetMaskBit32(m_flags, 27, 27, enable ? 1 : 0); }

    bool get_zmq_publish_enable() { return (btGetMaskBit32(m_flags, 27, 27) ? true : false); }

    uint8_t get_vlan_mode() { return (btGetMaskBit32(m_flags, 29, 28)); }

    void set_vlan_mode(uint8_t mode) { btSetMaskBit32(m_flags, 29, 28, mode); }

    void set_vlan_mode_verify(uint8_t mode);

    bool get_is_rx_check_enable() { return (btGetMaskBit32(m_flags, 31, 31) ? true : false); }

    void set_rx_check_enable(bool enable) { btSetMaskBit32(m_flags, 31, 31, enable ? 1 : 0); }

    bool get_is_slowpath_features_on() { return (btGetMaskBit32(m_flags1, 0, 0) ? true : false); }

    void set_slowpath_features_on(bool enable) { btSetMaskBit32(m_flags1, 0, 0, enable ? 1 : 0); }

    bool get_is_client_cfg_enable() { return (btGetMaskBit32(m_flags1, 1, 1) ? true : false); }
    ...
    void set_no_keyboard(bool enable) { btSetMaskBit32(m_flags1, 5, 5, enable ? 1 : 0); }

    bool get_no_keyboard() { return (btGetMaskBit32(m_flags1, 5, 5) ? true : false); }

    /* -e */
    void setClientServerFlowFlipAddr(bool enable) { btSetMaskBit32(m_flags1, 3, 3, enable ? 1 : 0); }

    bool getClientServerFlowFlipAddr() { return (btGetMaskBit32(m_flags1, 3, 3) ? true : false); }

    /* split mac is enabled */
    void setWDDisable(bool wd_disable) { btSetMaskBit32(m_flags1, 6, 6, wd_disable ? 1 : 0); }

    bool getWDDisable() { return (btGetMaskBit32(m_flags1, 6, 6) ? true : false); }

    void setCoreDumpEnable(bool enable) { btSetMaskBit32(m_flags1, 7, 7, (enable ? 1 : 0)); }

    bool getCoreDumpEnable() { return (btGetMaskBit32(m_flags1, 7, 7) ? true : false); }

    void setChecksumOffloadEnable(bool enable) { btSetMaskBit32(m_flags1, 8, 8, (enable ? 1 : 0)); }

    bool getChecksumOffloadEnable() { return (btGetMaskBit32(m_flags1, 8, 8) ? true : false); }

    void setCloseEnable(bool enable) { btSetMaskBit32(m_flags1, 9, 9, (enable ? 1 : 0)); }

    bool getCloseEnable() { return (btGetMaskBit32(m_flags1, 9, 9) ? true : false); }

    void set_rt_prio_mode(bool enable) { btSetMaskBit32(m_flags1, 10, 10, (enable ? 1 : 0)); }

    bool get_rt_prio_mode() { return (btGetMaskBit32(m_flags1, 10, 10) ? true : false); }

    void set_mlx5_so_mode(bool enable) { btSetMaskBit32(m_flags1, 11, 11, (enable ? 1 : 0)); }

    bool get_mlx5_so_mode() { return (btGetMaskBit32(m_flags1, 11, 11) ? true : false); }

    void set_mlx4_so_mode(bool enable) { btSetMaskBit32(m_flags1, 12, 12, (enable ? 1 : 0)); }

    bool get_mlx4_so_mode() { return (btGetMaskBit32(m_flags1, 12, 12) ? true : false); }

    void setChecksumOffloadDisable(bool enable) { btSetMaskBit32(m_flags1, 13, 13, (enable ? 1 : 0)); }

    bool getChecksumOffloadDisable() { return (btGetMaskBit32(m_flags1, 13, 13) ? true : false); }

    void set_dev_tso_support(bool enable) { btSetMaskBit32(m_flags1, 15, 15, (enable ? 1 : 0)); }

    bool get_dev_tso_support() { return (btGetMaskBit32(m_flags1, 15, 15) ? true : false); }

    void setTsoOffloadDisable(bool enable) { btSetMaskBit32(m_flags1, 16, 16, (enable ? 1 : 0)); }

    bool getTsoOffloadDisable() { return (btGetMaskBit32(m_flags1, 16, 16) ? true : false); }

    void set_ntacc_so_mode(bool enable) { btSetMaskBit32(m_flags1, 17, 17, (enable ? 1 : 0)); }

    bool get_ntacc_so_mode() { return (btGetMaskBit32(m_flags1, 17, 17) ? true : false); }

    void set_termio_disabled(bool enable) { btSetMaskBit32(m_flags1, 18, 18, (enable ? 1 : 0)); }

    bool get_is_termio_disabled() { return (btGetMaskBit32(m_flags1, 18, 18) ? true : false); }

    void setLroOffloadDisable(bool enable) { btSetMaskBit32(m_flags1, 19, 19, (enable ? 1 : 0)); }

    bool getLroOffloadDisable() { return (btGetMaskBit32(m_flags1, 19, 19) ? true : false); }

    void setPromMode(bool enable) { btSetMaskBit32(m_flags1, 20, 20, (enable ? 1 : 0)); }

    bool getPromMode() { return (btGetMaskBit32(m_flags1, 20, 20) ? true : false); }

    void setEmulDebug(bool enable) { btSetMaskBit32(m_flags1, 21, 21, (enable ? 1 : 0)); }

    bool getEmulDebug() { return (btGetMaskBit32(m_flags1, 21, 21) ? true : false); }

    uint8_t get_mac_ip_overide_mode() { return btGetMaskBit32(m_flags, 22, 23); }
...
class CParserOption {
  ...
  public:
    ...
    enum trex_astf_mode_e { OP_ASTF_MODE_NONE = 0, OP_ASTF_MODE_SERVR_ONLY = 1, OP_ASTF_MODE_CLIENT_MASK = 2 };
    ...
    enum trex_timesync_method { TIMESYNC_NONE = 0, TIMESYNC_PTP = 1 };
  ...
  public:
    void reset() {
        ...
        m_telnet_port = 4501;
        m_expected_portd =
            4; /* should be at least the number of ports found in the system but could be less. includes dummy ports */
        m_io_mode = 1;
        m_run_flags = 0;
        m_l_pkt_mode = 0;
        m_learn_mode = 0;
  ...
  public:
    uint8_t *get_src_mac_addr(int if_index) { return (m_mac_addr[if_index].u.m_mac.src); }
    uint8_t *get_dst_src_mac_addr(int if_index) { return (m_mac_addr[if_index].u.m_mac.dest); }

    uint32_t get_expected_ports() { return (m_expected_portd); }

    /* how many dual ports supported */
    uint32_t get_expected_dual_ports(void) { return (m_expected_portd >> 1); }

    uint32_t get_number_of_dp_cores_needed() { return ((m_expected_portd >> 1) * preview.getCores()); }
    bool is_latency_enabled() { return ((m_latency_rate == 0) ? false : true); }
    bool is_rx_enabled() { return m_rx_thread_enabled; }
    void set_rx_enabled() { m_rx_thread_enabled = true; }
    uint32_t get_x710_fdir_reset_threshold() { return (x710_fdir_reset_threshold); }
    void set_x710_fdir_reset_threshold(uint32_t val) { x710_fdir_reset_threshold = val; }

    inline double get_tw_bucket_time_in_sec(void) { return (m_tw_bucket_time_sec); }

    inline double get_tw_bucket_level1_time_in_sec(void) { return (m_tw_bucket_time_sec_level1); }
    ...
    void set_tw_buckets(uint16_t buckets) { m_tw_buckets = buckets; }

    inline uint16_t get_tw_buckets(void) { return (m_tw_buckets); }

    void set_tw_levels(uint16_t levels) { m_tw_levels = levels; }

    inline uint16_t get_tw_levels(void) { return (m_tw_levels); }

    inline void set_rxcheck_const_ts() { m_run_flags |= RUN_FLAGS_RXCHECK_CONST_TS; }
    inline void clear_rxcheck_const_ts() { m_run_flags &= ~RUN_FLAGS_RXCHECK_CONST_TS; }

    inline bool is_rxcheck_const_ts() { return ((m_run_flags & RUN_FLAGS_RXCHECK_CONST_TS) ? true : false); }

    inline uint8_t get_l_pkt_mode() { return (m_l_pkt_mode); }
    void dump(FILE *fd);
...
class CGlobalMemory {
  ...
  public:
    ...
    uint32_t get_2k_num_blocks() { return (m_mbuf[MBUF_2048]); }

    uint32_t get_each_core_dp_flows() { return (m_mbuf[MBUF_DP_FLOWS] / m_num_cores); }
    void set_number_of_dp_cors(uint32_t cores) { m_num_cores = cores; }

    void set_pool_cache_size(uint32_t pool_cache) { m_pool_cache_size = pool_cache; }
...
class CRteMemPool {
  ...
  public:
    ...
    inline rte_mbuf_t *HOT_FUNC pktmbuf_alloc_small() { return (_rte_pktmbuf_alloc(m_small_mbuf_pool)); }
  ...
  public:
    ...
    static inline bool is_learn_verify_mode() {
        return ((m_options.m_learn_mode != CParserOption::LEARN_MODE_DISABLED) &&
                m_options.preview.get_learn_and_verify_mode_enable());
    }

    static inline bool is_learn_mode() { return ((m_options.m_learn_mode != CParserOption::LEARN_MODE_DISABLED)); }
    ...
    static inline bool is_ipv6_enable(void) { return (m_options.preview.get_ipv6_mode_enable()); }
    ...
    static inline void set_realtime(bool enable) { m_options.preview.setRealTime(enable); }

    static uint32_t get_node_pool_size() { return (m_nodes_pool_size); }
    ...
    static inline void HOT_FUNC free_node(CGenNode *p) { rte_mempool_put(m_mem_pool[0].m_mbuf_global_nodes, p); }
...
static inline CDpdkModeBase *get_dpdk_mode() { return (CGlobalInfo::m_dpdk_mode.get_mode()); }

static inline CDpdkMode *get_mode() { return (&CGlobalInfo::m_dpdk_mode); }

/* more than 1 core with ASTF  mode */
static inline void set_op_mode(trex_traffic_mode_t mode) { get_mode()->set_opt_mode(mode); }

static inline void set_op_debug_mode(trex_traffic_mode_t mode) { get_mode()->switch_mode_debug(mode); }

static inline trex_traffic_mode_t get_op_mode() { return (get_mode()->get_opt_mode()); }

static inline int get_is_stateless() { return (get_op_mode() == OP_MODE_STL); }

static inline int get_is_stateful() { return (get_op_mode() == OP_MODE_STF); }
...
static inline int get_is_interactive() { return (get_mode()->is_interactive()); }

static inline int get_is_rx_check_mode() { return (CGlobalInfo::m_options.preview.get_is_rx_check_enable() ? 1 : 0); }

static inline uint16_t get_rx_check_hops() { return (CGlobalInfo::m_options.m_rx_check_hops); }

static inline bool isVerbose(int val) { return ((CGlobalInfo::m_options.preview.getVMode() > val) ? true : false); }
