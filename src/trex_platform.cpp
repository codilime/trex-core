...
socket_id_t CPlatformSocketInfoNoConfig::max_num_active_sockets() { return (1); }

socket_id_t CPlatformSocketInfoNoConfig::port_to_socket(port_id_t port) { return (0); }

void CPlatformSocketInfoNoConfig::set_rx_thread_is_enabled(bool enable) { m_rx_is_enabled = enable; }

void CPlatformSocketInfoNoConfig::set_number_of_dual_ports(uint8_t num_dual_ports) { m_dual_if = num_dual_ports; }

void CPlatformSocketInfoNoConfig::set_number_of_threads_per_ports(uint8_t num_threads) {
    m_threads_per_dual_if = num_threads;
}

bool CPlatformSocketInfoNoConfig::sanity_check() { return (true); }
...
virtual_thread_id_t CPlatformSocketInfoNoConfig::thread_phy_to_virt(physical_thread_id_t phy_id) { return (phy_id); }

physical_thread_id_t CPlatformSocketInfoNoConfig::thread_virt_to_phy(virtual_thread_id_t virt_id) { return (virt_id); }

physical_thread_id_t CPlatformSocketInfoNoConfig::get_master_phy_id() { return (0); }
...
void CPlatformSocketInfoNoConfig::dump(FILE *fd) { fprintf(fd, " there is no configuration file given \n"); }
...
socket_id_t CPlatformSocketInfoConfig::max_num_active_sockets() { return ((socket_id_t)m_sockets_enabled); }

socket_id_t CPlatformSocketInfoConfig::port_to_socket(port_id_t port) { return (m_socket_per_dual_if[(port >> 1)]); }

void CPlatformSocketInfoConfig::set_rx_thread_is_enabled(bool enable) { m_rx_is_enabled = enable; }

void CPlatformSocketInfoConfig::set_number_of_dual_ports(uint8_t num_dual_ports) { m_num_dual_if = num_dual_ports; }

void CPlatformSocketInfoConfig::set_number_of_threads_per_ports(uint8_t num_threads) {
    m_threads_per_dual_if = num_threads;
}

bool CPlatformSocketInfoConfig::sanity_check() { return (init()); }
...
physical_thread_id_t CPlatformSocketInfoConfig::get_master_phy_id() { return m_platform->m_master_thread; }
...
bool CPlatformSocketInfo::is_sockets_enable(socket_id_t socket) { return (m_obj->is_sockets_enable(socket)); }

socket_id_t CPlatformSocketInfo::max_num_active_sockets() { return (m_obj->max_num_active_sockets()); }

socket_id_t CPlatformSocketInfo::port_to_socket(port_id_t port) { return (m_obj->port_to_socket(port)); }

void CPlatformSocketInfo::set_rx_thread_is_enabled(bool enable) { m_obj->set_rx_thread_is_enabled(enable); }
...
bool CPlatformSocketInfo::sanity_check() { return (m_obj->sanity_check()); }

/* return the core mask */
uint64_t CPlatformSocketInfo::get_cores_mask() { return (m_obj->get_cores_mask()); }

void CPlatformSocketInfo::get_cores_list(char *core_list_ptr) { m_obj->get_cores_list(core_list_ptr); }
...
physical_thread_id_t CPlatformSocketInfo::get_master_phy_id() { return (m_obj->get_master_phy_id()); }

bool CPlatformSocketInfo::thread_phy_is_rx(physical_thread_id_t phy_id) { return (m_obj->thread_phy_is_rx(phy_id)); }

void CPlatformSocketInfo::dump(FILE *fd) { m_obj->dump(fd); }
