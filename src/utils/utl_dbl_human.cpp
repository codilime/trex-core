...
static uint8_t human_tbl[] = {' ', 'K', 'M', 'G', 'T'};
...
double CBwMeasure::calc_MBsec(uint32_t dtime_msec, uint64_t dbytes) {
...
float CPPSMeasure::calc_pps(uint32_t dtime_msec, uint32_t pkts) {
